---
description: SolvoBid CI budget. Keep PRs in draft while iterating, validate locally, batch pushes, and never spend GitHub Actions minutes on re-runs or cosmetic pushes. Apply before pushing to any branch with an open PR and before acting on CI results.
alwaysApply: true
---
